    ...
    <div class="col-md-12">
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#create" data-toggle="tab">@lang('task.text.tab.task_create')</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('category_id',$categories + ["" => "Please select a category"],old('category_id'),['class' => 'form-control','id' => 'category']) !!}
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('status',$status + ["" => "Please select a status"],old('status'),['class' => 'form-control','id' => 'status']) !!}
                                </div>
                                <div class="form-group">
                                    <label for="priority">@lang('task.text.labels.priority') *</label>
                                    <input type="number" name="priority" id="priority" class="form-control" value="{!! old('priority') !!}" min="{!! head(array_keys(config('task.priority'))) !!}" max="{!! last(array_keys(config('task.priority'))) !!}" placeholder="{!! head(array_keys(config('task.priority'))) !!} - {!! last(array_keys(config('task.priority'))) !!} between">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="description">@lang('task.text.labels.description')</label>
                                    <textarea data-toggle="wysihtml5" name="description" id="description" class="form-control">{!! old('description') !!}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-md-push-2">
                                ...
                                <ul class="list-group" id="client_list"></ul>
                            </div>
                        </div>
                    </div>
                </div><!-- /.tab-pane -->
