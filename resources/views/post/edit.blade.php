                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="source" id="source" class="form-control" value="{!! old('source',$post->source) !!}">
                                </div>
                                <div class="form-group">
                                    <label for="category">Хэлбэр *</label>
                                    {!! Form::select('category',$category + ["" => "Хэлбэрээ сонгоно уу"],old('category',$post->category),['class' => 'form-control','id' => 'category']) !!}
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea data-toggle="wysihtml5" name="text" id="text" class="form-control">{!! old('text',$post->text) !!}</textarea>
                            </div>
                        </div>
                    </div>
                </div><!-- /.tab-pane -->
