    ...
    <div class="col-md-12">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">User Edit - {{ $user->name }}</h3>
            ...
            <div class="box-body">
                <div class="col-md-6 col-md-push-3">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('role',$roles + ["" => trans('task.text.select_role')],old('role',$user->roles->first()->id),['class' => 'form-control','id' => 'form-control']) !!}
                    </div>
                </div>
            </div>
        </div>
