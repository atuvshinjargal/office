                            ...
                            <div class="col-md-12">
                                <table class="table table-hover task-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr data-toggle="modal" data-target="#task-modal" data-url="{!! route('task',$task->id) !!}" @if(in_array($task->status,[0,2])) style="text-decoration: line-through" @endif>
                                            <td>{{ $task->name }}</td>
                            ...
                            <div class="col-md-12">
                                <table class="table table-hover task-table">
                                    ...
                                    @forelse($tasks->get('open') as $task)
                                        <tr data-toggle="modal" data-target="#task-modal" data-url="{!! route('task',$task->id) !!}">
                                            <td>{!! $task->name !!}</td>
                                            <td>{!! $task->start_date->format('d.m.Y') !!}</td>
                                            <td>{!! $task->due_date_transform !!}</td>
                                            <td>{!! $task->priority !!}</td>
